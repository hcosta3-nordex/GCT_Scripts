...
def populate_xml_list():
    try:
        ...
        if not os.path.exists(namespaces_dir):
            messagebox.showerror("Error", f"'namespaces' folder not found in: {script_dir}")
            return
        ...
        messagebox.showerror("Error", f"Failed to load XML files: {e}")

def browse_zip():
    global user_changed_output, last_zip_dir
...
def browse_output():
    ...
    if output_dir:
        final_path_entry.delete(0, END)
        final_path_entry.insert(0, output_dir)
...
root = TkinterDnD.Tk()
icon_data = b""""""
...
root.title("Data Extraction Tool v6")
